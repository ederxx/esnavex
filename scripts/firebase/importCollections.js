...
/*
  ...
  Requirements:
    ...
    - The JSON files should be arrays of objects:
        profiles.json: [{ id: '<uid>', full_name, stage_name, avatar_url, phone, bio }, ...]
        user_roles.json: [{ id: '<docId or uid>', user_id: '<uid>', role: 'member'|'admin' }, ...]

  The script writes to Firestore collections: 'profiles' and 'user_roles'.
*/
